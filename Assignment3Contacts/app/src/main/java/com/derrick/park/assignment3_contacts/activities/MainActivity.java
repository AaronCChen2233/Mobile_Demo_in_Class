...
/**
 Requirements
 V Your app needs to compile and run.
 ...
 V Your app should be able to add a new contact. (You do not need to have a database for this assignment)
 V You need to validate user input.
 V Name : Two words (ex. John Doe)
